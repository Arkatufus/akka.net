...
namespace Akka.Persistence.Sqlite.Tests.Internal
{
    ...
    /// </summary>
    public abstract class SqlitePersistenceTestKit : Akka.TestKit.Xunit2.TestKit
    {
        /// <summary>
        /// Create a new instance of the <see cref="SqlitePersistenceTestKit"/> class.
        ...
        protected SqlitePersistenceTestKit(ActorSystemSetup setup, string actorSystemName = null, ITestOutputHelper output = null)
            : base(GetConfig(setup), actorSystemName, output)
        {
            ...
            Journal = TestSqliteJournal.FromRef(JournalActorRef);
        ...
        /// <param name="actorSystemName">Optional: The name of the actor system</param>
        /// <param name="output">TBD</param>
        protected SqlitePersistenceTestKit(Config config, string actorSystemName = null, ITestOutputHelper output = null)
        ...
        /// <param name="actorSystemName">Optional: The name of the actor system</param>
        /// <param name="output">TBD</param>
        protected SqlitePersistenceTestKit(string actorSystemName = null, ITestOutputHelper output = null)
        ...
        */
        ...
        private static Config GetConfig(Config customConfig)
        {
            ...
            else return customConfig.SafeWithFallback(defaultConfig);
        }
    }
}
