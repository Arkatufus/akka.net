...
namespace Akka.Persistence.Sqlite.Tests.Internal
{
    /// <summary>
    ...
    /// </summary>
    public abstract class SqliteBatchingPersistenceTestKit : Akka.TestKit.Xunit2.TestKit
    {
        /// <summary>
        /// Create a new instance of the <see cref="SqliteBatchingPersistenceTestKit"/> class.
        ...
        protected SqliteBatchingPersistenceTestKit(ActorSystemSetup setup, string actorSystemName = null, ITestOutputHelper output = null)
            : base(GetConfig(setup), actorSystemName, output)
        {
            ...
            Journal = TestBatchingSqliteJournal.FromRef(JournalActorRef);

            SnapshotsActorRef = persistenceExtension.SnapshotStoreFor(null);
            Snapshots = TestSqliteSnapshotStore.FromRef(SnapshotsActorRef);
        }
        ...
        /// <param name="actorSystemName">Optional: The name of the actor system</param>
        /// <param name="output">TBD</param>
        protected SqliteBatchingPersistenceTestKit(Config config, string actorSystemName = null, ITestOutputHelper output = null)
        ...
        /// <param name="actorSystemName">Optional: The name of the actor system</param>
        /// <param name="output">TBD</param>
        protected SqliteBatchingPersistenceTestKit(string actorSystemName = null, ITestOutputHelper output = null)
        ...
        /// 
        /// </summary>
        public ITestBatchingSqlJournal Journal { get; } 
        ...
        public async Task WithJournalBatching(Func<BatchingSqlJournalBehavior, Task> behaviorSelector, Func<Task> execution)
        {
            ...
            try
            {
                await behaviorSelector(Journal.OnBatching);
                await execution();
            }
            finally
            {
                await Journal.OnBatching.Pass();
            }
        }
        ...
        /// <returns><see cref="Task"/> which must be awaited.</returns>
        public Task WithJournalBatching(Func<BatchingSqlJournalBehavior, Task> behaviorSelector, Action execution)
            => WithJournalBatching(behaviorSelector, () =>
            {
                if (execution == null) throw new ArgumentNullException(nameof(execution));
